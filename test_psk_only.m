function test_psk_only(msg_bits_length)
    ...
    %% plot
    figure;
    semilogy(EbN0_dB, Pb_BPSK,'Marker', '<', 'LineWidth', 1.5, 'DisplayName', 'Theoretical BPSK/QPSK');
    hold on;
    semilogy(ebn0_range, BER_B,'--', 'Marker', 'o','LineWidth', 1.5,'DisplayName', 'Sim BPSK');
    semilogy(ebn0_range, BER_Q, '--', 'Marker', 's','LineWidth', 1.5, 'DisplayName', 'Sim QPSK');
    grid on;
    xlabel('E_b/N_0 (dB)');
    ylabel('BER (P_b)');
