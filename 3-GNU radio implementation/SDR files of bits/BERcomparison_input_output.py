# BER comparison input and output
""Author: Clara SORRE""
...
## bit vector
# It converts the bitstring to list of integers
...
with open(file_path, 'rb') as f:
    byte_data = f.read() # convert the bytes to bits
try:
...
L_output = []
L_input = []
for i in range (0,1000): #if issue is occuring at a certain spot in the bitstream
...
while True:
    ...
    start = index + 1  # move +1 to find the next occurrence
print("The preamble has been found at indices:", positions)