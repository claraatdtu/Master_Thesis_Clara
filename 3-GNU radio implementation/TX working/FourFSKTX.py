...
class FourFSKTX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "4FSKTX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("4FSKTX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FourFSKTX")
...
def main(top_block_cls=FourFSKTX, options=None):
