...
class EightFSKTX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "8FSKTX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("8FSKTX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "EightFSKTX")
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.qtgui_sink_x_0_0_0, 0))
...
def main(top_block_cls=EightFSKTX, options=None):
