...
class LoRaTX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LoRaTX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LoRaTX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LoRaTX")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.soapy_hackrf_sink_0, 0))
        ...
        self.connect((self.lora_sdr_modulate_0, 0), (self.blocks_add_xx_1, 1))
        self.connect((self.lora_sdr_modulate_0, 0), (self.qtgui_sink_x_0_0, 0))
...
def main(top_block_cls=LoRaTX, options=None):
