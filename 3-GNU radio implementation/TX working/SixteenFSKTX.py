...
class SixteenFSKTX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "16FSKTX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("16FSKTX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SixteenFSKTX")
...
def main(top_block_cls=SixteenFSKTX, options=None):
