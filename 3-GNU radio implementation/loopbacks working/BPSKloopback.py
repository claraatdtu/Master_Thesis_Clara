...
import BPSKloopback_epy_block_0 as epy_block_0  # embedded python block
import BPSKloopback_wform as wform  # embedded python module
import math
import sip



class BPSKloopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSKloopback")
        ...
        self._eb_n0_dB_range = qtgui.Range(-5, 15, 1/100, 7, 200)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(1/(M*math.sqrt((1**2))))
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\clsor\\OneDrive\\Documents\\MATLAB\\Master_Thesis_Clara\\Master_Thesis_Clara\\3-GNU radio implementation\\SDR files of bits\\BPSKsdroutput5', False)
    ...
    def set_M(self, M):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(1/(self.M*math.sqrt((1**2))))
...
def main(top_block_cls=BPSKloopback, options=None):
