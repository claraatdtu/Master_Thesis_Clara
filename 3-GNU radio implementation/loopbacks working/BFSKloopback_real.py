...
"""This script provides the blocks for the BFSK loopback modulation-demodulation with adding of AWGN."""
...
import BFSKloopback_real_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip



class BFSKloopback_real(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BFSKloopback_real")
...
def main(top_block_cls=BFSKloopback_real, options=None):
