...
import EightFSKloopback_epy_block_0_0 as epy_block_0_0  # embedded python block
import sip



class EightFSKloopback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "8FSKloopback", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("8FSKloopback")
        ...
        self.settings = Qt.QSettings("GNU Radio", "EightFSKloopback")
        ...
        self.fsk_deviation = fsk_deviation = bw/3
        ...
        self.qtgui_time_sink_x_2_0_0_2_0 = qtgui.time_sink_f(
            (32*bps), #size
            samp_rate, #samp_rate
            'TX float to char 0 1 2 3 4 5 6 7', #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_2_0_0_2_0.set_update_time(0.10)
        self.qtgui_time_sink_x_2_0_0_2_0.set_y_axis(0, 7)
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bf([-4, -3, -2, -1, 0, 1, 2, 3], 1)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_float*1024, 'C:\\Users\\clsor\\OneDrive\\Documents\\MATLAB\\Master_Thesis_Clara\\Master_Thesis_Clara\\3-GNU radio implementation\\SDR bandwidths\\8FSKbw12', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\clsor\\OneDrive\\Documents\\MATLAB\\Master_Thesis_Clara\\Master_Thesis_Clara\\3-GNU radio implementation\\SDR files of bits\\8FSKsdroutput-5', False)
        ...
        self.blocks_add_const_vxx_0_1_0 = blocks.add_const_ff(4)
        self.blocks_add_const_vxx_0_1 = blocks.add_const_ff(4)
    ...
    def set_bw(self, bw):
        self.bw = bw
        self.set_fsk_deviation(self.bw/3)
...
def main(top_block_cls=EightFSKloopback, options=None):
