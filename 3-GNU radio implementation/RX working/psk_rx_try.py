...
import math
import psk_rx_try_wform as wform  # embedded python module
import sip



class psk_rx_try(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "psk_rx_try")
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(292, (2*math.pi/100), firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(Sps), 0.35, 11*Sps*nfilts), 32, 16, 1.5, 4)
        self.digital_costas_loop_cc_0_0 = digital.costas_loop_cc((math.pi/100), M, False)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc((math.pi/100), M, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\clsor\\OneDrive\\Documents\\MATLAB\\Master_Thesis_Clara\\Master_Thesis_Clara\\3-GNU radio implementation\\SDR files of bits\\BPSKsdroutput', False)
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
...
def main(top_block_cls=psk_rx_try, options=None):
