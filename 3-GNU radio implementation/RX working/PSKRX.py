...
import PSKRX_wform as wform  # embedded python module
import math
import sip
...
class PSKRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.msg_connect((self.pdu_tagged_stream_to_pdu_0, 'pdus'), (self.pdu_pdu_to_tagged_stream_0, 'pdus'))
        self.connect((self.analog_agc3_xx_0, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.digital_clock_recovery_mm_xx_0_0, 0), (self.digital_corr_est_cc_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_unpacked_to_packed_xx_0, 0))
        self.connect((self.digital_corr_est_cc_0, 0), (self.analog_agc3_xx_0, 0))
        self.connect((self.digital_correlate_access_code_xx_ts_0, 0), (self.blocks_char_to_float_0_1_0, 0))
