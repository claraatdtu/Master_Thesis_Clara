...
class FourFSKRX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "4FSKRX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("4FSKRX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FourFSKRX")
...
def main(top_block_cls=FourFSKRX, options=None):
