...
class EightFSKRX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "8FSKRX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("8FSKRX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "EightFSKRX")
...
def main(top_block_cls=EightFSKRX, options=None):
