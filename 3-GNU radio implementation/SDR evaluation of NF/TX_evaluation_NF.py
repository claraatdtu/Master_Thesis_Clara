...
class TX_evaluation_NF(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "TX_evaluation_NF", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("TX_evaluation_NF")
        ...
        self.settings = Qt.QSettings("GNU Radio", "TX_evaluation_NF")
        ...
        self.soapy_hackrf_source_1.set_frequency(0, (center_freq-3500000))
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range((self.center_freq-1500000), self.samp_rate)
        self.soapy_hackrf_source_1.set_frequency(0, (self.center_freq-3500000))




def main(top_block_cls=TX_evaluation_NF, options=None):
