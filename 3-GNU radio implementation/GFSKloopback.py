...
import GFSKloopback_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
...
class GFSKloopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.num_samples = num_samples = 1000000
        ...
        self.blocks_delay_1_0_0_0 = blocks.delay(gr.sizeof_char*1, 0)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.digital_gfsk_demod_0, 0))
        ...
        self.connect((self.blocks_delay_1_0_0_0, 0), (self.blocks_skiphead_0, 0))
        self.connect((self.blocks_float_to_char_0_0, 0), (self.blocks_skiphead_0_0, 0))
        ...
        self.connect((self.blocks_skiphead_0, 0), (self.blocks_char_to_float_0_1, 0))
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.blocks_float_to_char_0_0, 0))
        ...
        self.connect((self.digital_gfsk_demod_0, 0), (self.blocks_char_to_float_0_0_0_0, 0))
        self.connect((self.digital_gfsk_demod_0, 0), (self.blocks_repeat_0_0, 0))
        self.connect((self.digital_gfsk_mod_0, 0), (self.blocks_sub_xx_0, 1))
