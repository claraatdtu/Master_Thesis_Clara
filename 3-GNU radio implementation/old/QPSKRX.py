...
import QPSKRX_wform as wform  # embedded python module
import math
import sip



class QPSKRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSKRX")
        ...
        self.analog_pwr_squelch_xx_0 = analog.pwr_squelch_cc((-30), (1e-4), 0, True)
...
def main(top_block_cls=QPSKRX, options=None):
