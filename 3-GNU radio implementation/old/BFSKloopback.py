...
import BFSKloopback_epy_block_0 as epy_block_0  # embedded python block
import sip



class BFSKloopback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BFSKloopback", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BFSKloopback")
        ...
        self.settings = Qt.QSettings("GNU Radio", "BFSKloopback")
        ...
        self.blocks_delay_1_0_0_0 = blocks.delay(gr.sizeof_char*1, 2)
...
def main(top_block_cls=BFSKloopback, options=None):
