...
import default_wform as wform  # embedded python module
import math
import sip
...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\clsor\\OneDrive\\Documents\\MATLAB\\Master_Thesis_Clara\\Master_Thesis_Clara\\3-GNU radio implementation\\SDR files of bits\\BPSKsdroutput', False)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_1_0, 0))
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.digital_symbol_sync_xx_0, 0))
