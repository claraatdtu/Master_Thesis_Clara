...
import BFSKHackRF_Rx_NONcoherent_epy_block_0 as epy_block_0  # embedded python block
import math
import sip



class BFSKHackRF_Rx_NONcoherent(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BFSKHackRF_Rx_NONcoherent")
        ...
        self.qtgui_time_sink_x_0_2.set_y_axis(-0.5, 1.5)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (center_freq-fsk_deviation), 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, (center_freq+fsk_deviation), 1, 0, 0)
        ...
        self.connect((self.blocks_char_to_float_0_0_1, 0), (self.qtgui_time_sink_x_2_0, 1))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_time_sink_x_2_0, 0))
        self.connect((self.blocks_char_to_float_0_2, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.blocks_sub_xx_1_0, 0))
        self.connect((self.blocks_complex_to_mag_squared_0_0, 0), (self.blocks_sub_xx_1_0, 1))
        ...
        self.connect((self.blocks_repeat_0_0, 0), (self.blocks_char_to_float_0_2, 0))
        self.connect((self.blocks_stream_mux_1, 0), (self.blocks_char_to_float_0_1, 0))
        self.connect((self.blocks_stream_mux_1, 0), (self.blocks_repeat_0, 0))
        self.connect((self.blocks_stream_mux_1, 0), (self.fec_ber_bf_0, 0))
        self.connect((self.blocks_sub_xx_0, 0), (self.analog_frequency_modulator_fc_0, 0))
        self.connect((self.blocks_sub_xx_1_0, 0), (self.digital_clock_recovery_mm_xx_0_0, 0))
...
def main(top_block_cls=BFSKHackRF_Rx_NONcoherent, options=None):
