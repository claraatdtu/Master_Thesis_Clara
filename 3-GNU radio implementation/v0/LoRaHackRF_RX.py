...
import LoRaHackRF_RX_epy_block_1 as epy_block_1  # embedded python block
...
class LoRaHackRF_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LoRaHackRF_RX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LoRaHackRF_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LoRaHackRF_RX")
        ...
        self.lora_sdr_frame_sync_0.set_max_output_buffer(8192)
        ...
        self.connect((self.epy_block_1, 0), (self.lora_sdr_frame_sync_0, 0))
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.epy_block_1, 0))
...
def main(top_block_cls=LoRaHackRF_RX, options=None):
